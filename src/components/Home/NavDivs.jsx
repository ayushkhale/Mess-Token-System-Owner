...
const NavDivs = () => {
  ...
  const categories = [
    { id: '2', name: 'Buy Tokens', icon: 'savings', screen: 'Tokens' },
    { id: '1', name: 'Token Details', icon: 'currency-exchange', screen: 'TokenHistory' },
    { id: '3', name: 'Cash History', icon: 'history', screen: 'PaymentHistory' }
  ];
